...
cases <- list(
  list(d = low_rank_data, label = "low-dimensional OU block"),
  list(d = high_rank_data, label = "high-dimensional OU block")
)
...
results_file <- "performance/covariance/benchmark-ou-results.rds"
